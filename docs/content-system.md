...
4. **Make what lasts / 做出你的代表作：**把经得住检验的判断做成持续创造价值、也会长期代表和成就创作者的作品；作品继续为别人工作，也持续为创作者积累能力、信誉、自由和更大的下一步。

Hero只承担前两层；经历与公开判断负责让它接触现实；中英文Work区分别以`SUPERLINEAR ACADEMY · Make what lasts.`和`SUPERLINEAR ACADEMY · 做出你的代表作。`命名这条主线最终要形成的东西。它是个人判断进入Superlinear实践的落点，不替换个人Hero，也不在Hero、Work和footer反复出现。
...
Superlinear Academy的中英文母品牌signature是`MAKE WHAT LASTS. / 做出你的代表作。`。当前个人网站分别只在中英文Work区直接出现一次：上方个人主线回答“什么值得做”，这里回答“经得住现实的判断要长成什么”。英文强调作品完成以后仍继续工作，中文强调做出真正属于自己、被现实选择、也会长期代表和成就自己的作品。完整含义与跨产品层级由私有课程营销系统中的`00_strategy/superlinear-brand-platform.md`维护。
