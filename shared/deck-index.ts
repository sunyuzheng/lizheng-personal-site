...
export const DECK_LIBRARY: DeckEntry[] = [
  ...
  },
  {
    ...
    organization: "课代表立正",
    occasion: {
      en: "Long-form video argument · public cue-card edition",
      zh: "长视频论证·公开口播导航卡",
    },
    title: "AI会让假工作先爆炸，再贬值",
    date: "2026-09-01",
    language: "zh",
    audience: {
      en: "Knowledge workers and leaders rethinking what remains valuable when AI makes work evidence abundant",
      zh: "正在重新理解AI时代什么工作仍然值钱的知识工作者与管理者",
    },
    takeaway: {
