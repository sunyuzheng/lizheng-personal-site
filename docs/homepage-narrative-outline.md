...
Updated September 7, 2026. This brief records the reviewed homepage narrative; subsequent public changes require review and approval. Personal facts and philosophy remain owned by `yuzheng-profile`, not this page brief.
...
2. **Founder motivation — immediately after the hero.** Keep `我为什么创办超线性学院。` / `Why I founded Superlinear Academy.` Lead with the user-approved three-part narrative: the transformation recognized in 2023; AI as both a flood reshaping careers and education and a second Renaissance of individual self-discovery and liberation; and the founder's commitment to teaching people to harness AI and building a city for creators. The opening links to the Knowledge Bank version of the 2023 essay (https://www.superlinear.academy/c/ai-resources/chatgpt); `学会游泳与造船` links to AI Builders. The word “Florence” links to the published Knowledge Bank essay “AI会带来第二次文艺复兴，我们需要自己的佛罗伦萨” (https://www.superlinear.academy/c/ai-resources/ai-second-renaissance-florence), using the same inline style as the swimming/boat-building link, with no additional reading entry. This is the current concise expression of his longstanding judgment and ambition, not a claim that the 2023 article used these exact metaphors. Place the preserved Tencent 30-person team and early Statsig biography beside the vision on desktop and after it on mobile, with the career line and About link. Do not infer resignation or any other reason for leaving Statsig. Preserve `OpenAI收购团队早期成员`; the biography explicitly names Statsig as the company later acquired. Follow with one compact group of four peer endorsements: Liu Jia, Wei Manfredi, Vijaye Raji, and Dai Yusen. Names, roles, and faithful short excerpts remain visible; one link goes directly to all four full quotations on About.
3. **Conversations.** The September 10 update replaces mixed channel thumbnails with unbranded editorial covers: a topic and short headline on the left, a real portrait on the right, then a clear guest name and significant role below. Topic choices come from the actual episode titles, covers and content, showing the range and depth of the conversations. Eight guests appear in four wide-desktop columns, two intermediate columns and one mobile column. Chinese includes Howie Xu; English retains Gergely Orosz. Roundtables are identified explicitly. Preserve the separate meanings of 200+ conversations and 400K+ followers. Curation, sources and the publication status are recorded in `docs/reviews/conversations-2026-09-10.md`.
4. **Writing and dated arguments.** Keep the three Knowledge Bank article titles and reading reasons. Place the April 2021 and pre-GPT-4 February 2023 records here so dated judgments sit beside the writing. All homepage links to the 2023 essay use its Knowledge Bank version, which includes later review; label it “Read the 2023 essay,” rather than describing this updated version as a fixed historical snapshot.
