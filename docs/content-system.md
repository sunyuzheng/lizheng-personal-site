...
4. **Make what lasts：**把经得住检验的判断做成持续创造价值的作品；作品继续为别人工作，也持续为创作者积累能力、信誉、自由和更大的下一步。

Hero只承担前两层；经历与公开判断负责让它接触现实；英文Work区再以`SUPERLINEAR ACADEMY · Make what lasts.`命名这条主线最终要形成的东西。它是个人判断进入Superlinear实践的落点，不替换个人Hero，也不在Hero、Work和footer反复出现。
...
5. 最后由访谈、书、社区结果和同行评价完成第三方验证，并说明哪些作品仍在为别人创造价值，又如何持续复利回创作者本人。

不是先宣布“权威”，再找材料支持；而是先给事实和场景，帮助读者理解它说明什么，再把结论留给读者。

## 品牌与产品的关系

Superlinear Academy的英文母品牌signature是`MAKE WHAT LASTS.`。当前个人网站只在英文Work区直接出现一次：上方个人主线回答“什么值得做”，这里回答“经得住现实的判断要长成什么”。完整含义与跨产品层级由私有课程营销系统中的`00_strategy/superlinear-brand-platform.md`维护。
