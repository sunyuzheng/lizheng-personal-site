...
首页把这件事说得更直接：“先把判断说清楚，再让现实来挑错。”经历、公开判断、当前工作、书和访谈分别回答这句话为什么可信。`Build AI systems that compound` 仍然是 AI 工作的一条主张，但不再承担整个人主页的首屏定位。

首页的阅读顺序是：

1. 先看到一句可以被检验的主张；
2. 再看到这套做法从哪里形成、怎样进入产品和组织；
3. 接着看有时间戳的公开判断；
4. 然后看判断怎样被教成能力、放进长期环境、用于企业现场；
5. 最后由访谈、书、社区结果和同行评价完成第三方验证。
