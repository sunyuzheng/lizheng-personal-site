...
Superlinear Academy的英文母品牌signature是`MAKE WHAT LASTS.`。在个人网站上，它可以用于统领Work区或作为结尾签名，但不自动替换个人Hero。完整含义与跨产品层级由私有课程营销系统中的`00_strategy/superlinear-brand-platform.md`维护。
